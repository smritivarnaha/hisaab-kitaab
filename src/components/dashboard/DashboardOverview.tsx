...
export const DashboardOverview: React.FC = () => {
  ...
  const { praveenIncome, sarthakIncome, praveenExpense, sarthakExpense, netProfit, fairSharePerPartner, settlementText } = businessSettlement;
  ...
  return (
    <div className="flex-1 overflow-y-auto px-2 sm:px-4 py-2.5 sm:py-4 pb-24 sm:pb-16 no-scrollbar bg-[#F3F5F1] font-outfit space-y-2.5 sm:space-y-4 w-full max-w-4xl mx-auto">
