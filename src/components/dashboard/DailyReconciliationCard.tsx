            ...
            >
              ...
              <div className="flex items-center gap-1.5 pt-1 w-full min-w-0">
                <input
                  ...
                  className="min-w-0 flex-1 bg-[#F3F5F1] border border-[#E2E8E0] rounded-full py-1 px-2.5 text-xs text-[#0D2E14] outline-none font-semibold placeholder-gray-400 focus:border-[#0D2E14]"
                />
                ...
                <div className="flex items-center gap-1 flex-shrink-0">
                  <button
                    ...
                    className="px-2.5 py-1 rounded-full bg-[#0D2E14] text-white text-xs font-bold flex items-center gap-1 disabled:opacity-30 transition-all active:scale-95 flex-shrink-0"
                  >
                  ...
                  <button
                    ...
                    className="p-1 rounded-full bg-red-50 text-red-600 hover:bg-red-100 border border-red-200 transition-all active:scale-95 flex-shrink-0"
